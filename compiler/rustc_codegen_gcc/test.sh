...
function std_tests() {
    echo "[AOT] pointers_and_wrappers"
    $RUSTC example/pointers_and_wrappers.rs --crate-name pointers_and_wrappers --crate-type bin --target $TARGET_TRIPLE
    $RUN_WRAPPER ./target/out/pointers_and_wrappers
